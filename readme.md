...
6. **Feet** - Under units in a staggered column: a tree trunk or an inverted triangle that continues the case's lower faces to the floor. Both slide into the back bottom's groove on a dovetail rail
